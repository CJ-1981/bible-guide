      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 flex items-center gap-4">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <Link href="/harmony"><Button variant="ghost" size="sm" className="text-xs gap-1 h-8 px-2" title="사화조화 — 네 복음서의 동일 사건 병렬 비교"><span>📚</span><span className="hidden md:inline">사화조화</span></Button></Link>
            <DarkModeToggle />
          </div>
        </div>
      </header>
